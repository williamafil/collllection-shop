...
const Search = () => {
  ...
  return (
    <div className="px-5 pb-10 container mx-auto">
      <main className="min-h-screen/2 flex flex-col lg:flex-row space-y-16 lg:space-y-0 lg:space-x-8">
        <aside className="w-full lg:w-5/12">
          ...
          <div className="mt-4 lg:mt-10 lg:pr-4">
            <SearchForm
              ...
              className="text-2xl border-black w-full placeholder-black"
        ...
        <section className="lg:w-full">
          {isLoading ? (
            <div className="pt-14 flex justify-center text-black">
              <LoadingIcon />
            </div>
          ) : (
